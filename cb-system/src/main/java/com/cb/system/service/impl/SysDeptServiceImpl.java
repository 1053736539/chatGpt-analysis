...
import com.cb.system.mapper.SysRoleMapper;
...
public class SysDeptServiceImpl implements ISysDeptService {
    ...
    @Override
    public Map<String, SysDept> getDeptMapByCode() {
    ...
    public List<SysDept> selectChargeDeptList(Long userId) {
        return deptMapper.selectChargeDeptList(userId);
    }

    @Override
    public Map<String, List<SysDeptBasicInfoVo>> getDeptList4PersonnelType() {
        List<SysDeptBasicInfoVo> list = deptMapper.getDeptBasicInfoList4PersonnelType();
        List<SysDeptBasicInfoVo> civil_servant = list.stream().filter(o -> "1".equals(o.getDeptIdentityType())).collect(Collectors.toList());
        List<SysDeptBasicInfoVo> institution = list.stream().filter(o -> "3".equals(o.getDeptIdentityType())).collect(Collectors.toList());
        Map<String, List<SysDeptBasicInfoVo>> rst = new HashMap<>();
        rst.put("civil_servant", civil_servant);
        rst.put("institution", institution);
        return rst;
    }
    ...
    @Override
    public List<SysDept> selectDeptTreeList(Long rootDeptId, int maxLevel) {
        return deptMapper.selectDeptTreeList(rootDeptId, maxLevel);
    }
}
