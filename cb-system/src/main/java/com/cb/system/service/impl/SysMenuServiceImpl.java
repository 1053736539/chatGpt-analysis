...
import com.cb.system.domain.vo.MetaVo;
import com.cb.system.domain.vo.RouterVo;
import com.cb.system.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService
{
    ...
    public List<SysMenu> selectMenuTreeByUserId(Long userId) {
        ...
        if (!commonConfigService.selectThreeMemberSwitch() && SecurityUtils.isAdmin(userId)) {
