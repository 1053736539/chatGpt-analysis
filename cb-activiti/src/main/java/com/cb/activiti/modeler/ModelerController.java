package com.cb.activiti.modeler;
...
import static com.cb.common.core.domain.AjaxResult.error;
import static com.cb.common.core.domain.AjaxResult.success;
...
public class ModelerController extends BaseController {
    ...
    public TableDataInfo list(ModelEntityImpl modelEntity) {
        ...
        // 条件过滤
        if (com.cb.common.utils.StringUtils.isNotBlank(modelEntity.getKey())) {
            modelQuery.modelKey(modelEntity.getKey());
        }
        if (com.cb.common.utils.StringUtils.isNotBlank(modelEntity.getName())) {
