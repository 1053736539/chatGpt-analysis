...
public class BizLeave extends ProcessEntity
{
    ...
    /** 请假类型 */
    @Excel(name = "请假类型",readConverterExp = "1=公休假,2=病假,3=事假,4=探亲假,5=婚假,6=丧假,7=产假,8=哺乳假,9=育儿假,10=老年人护理假,11=补休")
    private Long type;
     ...
     * 是否生病住院请假
     */
    @Excel(name = "是否生病住院请假",readConverterExp = "0=否,1=是" )
     ...
     * 状态 0待审核 1审核通过 2不通过
     */
    @Excel(name = "审核状态",readConverterExp = "0=未审核,1=审核通过, 2=不通过,3=审核中")
    private String status;
    /**
     * 是否离昆
     */
    @Excel(name="是否离昆",readConverterExp = "0=否,1=是")
    ...
    public void setInspectionTeamHeadOpinions(String inspectionTeamHeadOpinions) {
        this.inspectionTeamHeadOpinions = inspectionTeamHeadOpinions;
    }
