...
import com.cb.activiti.service.IProcessDefinitionService;
...
public class ProcessDefinitionService implements IProcessDefinitionService {
     ...
     */
    @Override
    public Page<com.cb.activiti.domain.ProcessDefinition> listProcessDefinition(com.cb.activiti.domain.ProcessDefinition processDefinition) {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<com.cb.activiti.domain.ProcessDefinition> list = new Page<>();
        ...
        for (ProcessDefinition definition: processDefinitionList) {
            ...
            com.cb.activiti.domain.ProcessDefinition entity = new com.cb.activiti.domain.ProcessDefinition();
