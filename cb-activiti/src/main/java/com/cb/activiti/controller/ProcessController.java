...
import com.cb.activiti.config.ICustomProcessDiagramGenerator;
import com.cb.activiti.config.WorkflowConstants;
...
//                InputStream imageStream = pec.generateDiagram(bpmnModel, "png", executedActivityIdList, flowIds,"宋体","微软雅黑","黑体",null,2.0);
    ...
    private List<String> getHighLightedFlows(BpmnModel bpmnModel,ProcessDefinitionEntity processDefinitionEntity,List<HistoricActivityInstance> historicActivityInstances) {
        ...
        for (int i = 0; i < historicActivityInstances.size() - 1; i++) {
            ...
            List<SequenceFlow> pvmTransitions = null != activityImpl ? activityImpl.getOutgoingFlows() : Collections.emptyList(); // 取出节点的所有出去的线
...
//    @ResponseBody
//    @Scheduled
//    public TableDataInfo taskAllList(TaskVo taskVo) {
//        startPage();
//        return processService.findAllTodoTasks(taskVo);
//    }
