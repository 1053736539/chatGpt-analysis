...
/**
 * 普查人员部门对象 census_dept
 * 
 * @author yangcd
 * @date 2023-11-11
 */
public class CensusDept extends BaseEntity
{
    ...
    /** 子部门 */
    private List<CensusDept> children = new ArrayList<CensusDept>();
    ...
    public List<CensusDept> getChildren() {
        return children;
    }

    public void setChildren(List<CensusDept> children) {
