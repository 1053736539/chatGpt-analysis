...
/**
 * 电费-原始数据对象 bas_electricity_fees_source
 * 
 * @author ouyang
 * @date 2024-10-29
 */
public class BasElectricityFeesSource extends BaseEntity
{
    ...
    private BasElectricityFees electricityFees;
    ...
    public BasElectricityFees getElectricityFees() {
        return electricityFees;
    }

    public void setElectricityFees(BasElectricityFees electricityFees) {
