...
public class SysDictDataController extends BaseController
{
     ...
     * 根据字典类型查询字典数据信息
     */
    @GetMapping(value = "/typeTree/{dictType}")
    public AjaxResult dictTypeTreeDate(@PathVariable String dictType)
    {
        List<DictDataVo> data = dictTypeService.selectDictDataTreeByType(dictType);
        if (StringUtils.isNull(data))
        {
            data = new ArrayList<DictDataVo>();
        }
        return AjaxResult.success(data);
    }
