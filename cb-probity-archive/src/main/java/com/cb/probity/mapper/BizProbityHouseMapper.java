...
/**
 * 廉政档案-12.本人、配偶、共同生活的子女为所有权人或者共有人的房产、车位、车库情况Mapper接口
 *
 * @author ruoyi
 * @date 2025-03-18
 */
public interface BizProbityHouseMapper {
    /**
     ...
     * @return 结果
     */
    public int insertBatch(@Param("entities") List<BizProbityHouse> entities);
